...
impl Unsplash {
    ...
    pub fn get_photo(&self, photo_id: &str) -> Result<Photo, reqwest::Error> {
    ...
    pub fn get_random_photo(&self, params: RandomPhotoParams) -> Result<Photo, reqwest::Error> {
    ...
    pub fn get_photo_of_the_day(&self) -> Result<Photo, reqwest::Error> {
